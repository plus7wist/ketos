...
mod test {
	...
	fn test_downcast() {
		...
		let b = <dyn SomeTrait>::downcast::<Dumber>(a).unwrap_err();
		let c = <dyn SomeTrait>::downcast::<Dummy>(b).unwrap();
	...
	fn test_downcast_rc() {
		...
		let b = <dyn SomeTrait>::downcast_rc::<Dumber>(a).unwrap_err();
		let c = <dyn SomeTrait>::downcast_rc::<Dummy>(b).unwrap();
